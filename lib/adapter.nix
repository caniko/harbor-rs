...
rec {
  ...
  isHarborAdapter = v:
    builtins.isAttrs v
    && v ? _type && v._type == "harbor-adapter"
    && v ? _version && builtins.isInt v._version
    && v ? attic && builtins.isAttrs v.attic
    && v.attic ? endpoint && builtins.isString v.attic.endpoint
    && v.attic ? cache && builtins.isString v.attic.cache;
